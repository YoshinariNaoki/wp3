...
<div class="header">
  <div class="container">
    ...
    <div class="menu">
	   <a class="toggleMenu" href="#"><img src="<?php echo home_url(); ?>" alt="" /> </a>
	   <ul class="nav" id="nav">
	  ...
	  <script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/js/responsive-nav.js"></script>
	</div>							
...
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/js/fliplightbox.min.js"></script>
...
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery.fancybox-1.2.1.js"></script>
	<script type="text/javascript">
